...
class _ClassMemory
{
    ...
    ; Method:    memoryJmp(pDestination, pAddress, pByte)
    ; parameters:
    ;   pDestination    The address of the memory to be jmp.
    ;   pAddress        The current address of the memory.
    ...
    ; Method:    getByteJmp(pDestination, pAddress)
    ; parameters:
    ;   pAddress    The address of the current location.
    ;   pDestination    The address of the destination.
    ...
    ; Method:    hex(int)
    ; parameters:
    ;   int    The number to be converted to hex.
